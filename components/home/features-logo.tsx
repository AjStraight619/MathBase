...
export default function FeaturesLogo() {
  ...
  useEffect(() => {
    ...
    const handleAnimateDrawInitial = async () => {
      if (scope.current) {
        await Promise.all([
          animatePath("#path2"),
          animatePath("#path3"),
    ...
    handleAnimateDrawInitial().then(() => setIsInitialDrawDone(true));
  }, [scope, animate, isInitialDrawDone]);

  useEffect(() => {
    if (!isInitialDrawDone) return;

    const animatePulse = async (path: string, props: any) => {
      await animate(path, { pathLength: [1, 0], pathOffset: [1, 0] }, props);
    };

    const handlePulseAnimation = () => {
      animatePulse("#pulse-path2", {
        duration: 1,
        ease: "easeInOut",
        repeat: Infinity,
        repeatDelay: 1.5,
      });
      animatePulse("#pulse-path3", {
        duration: 0.8,
        ease: "easeInOut",
        repeat: Infinity,
        repeatDelay: 2,
      });
      animatePulse("#pulse-path4", {
        duration: 1,
        ease: "easeInOut",
        repeat: Infinity,
        repeatDelay: 1,
      });
      animatePulse("#pulse-path5", {
        duration: 1,
        ease: "easeInOut",
        repeat: Infinity,
        repeatDelay: 1.5,
  ...
  const pulsePaths = [
    { id: "pulse-path2", data: reactPathData, stroke: "url(#blue-pulse-1)" },
    {
      id: "pulse-path3",
      data: wolframPathDataRight,
      stroke: "url(#orange-pulse-1",
    },
    { id: "pulse-path4", data: nextjsPathData, stroke: "url(#blue-pulse-2)" },
    {
      id: "pulse-path5",
      data: wolframPathDataLeft,
      stroke: "url(#orange-pulse-1)",
    },
    { id: "pulse-path6", data: gptLeftPathData, stroke: "url(#pink-pulse-1)" },
    { id: "pulse-path7", data: gptRightPathData, stroke: "pink" },
  ];
  ...
  return (
    <div ref={scope} className="mx-auto">
      ...
      >
          ...
          {isInitialDrawDone &&
            pulsePaths.map((path) => (
              <path
                ...
                stroke={path.stroke}
                {...pulsePathStyles}
                filter={path.id === "pulse-path7" ? "none" : "url(#glow)"}
              />
            ))}
        </g>
        <defs>
        ...
        <defs>
          <linearGradient id="blue-pulse-1" x1="0" y1="100%" x2="100%" y2="0">
            <stop stopColor="#2EB9DF" stopOpacity="0"></stop>
            <stop offset="0.05" stopColor="#2EB9DF"></stop>
            <stop offset="0.5" stopColor="#6FD4F2"></stop>
            <stop offset="1" stopColor="#2EB9DF" stopOpacity="0"></stop>
          </linearGradient>

          <linearGradient id="blue-pulse-2" x1="0" y1="0" x2="100%" y2="100%">
            <stop stopColor="#2EB9DF" stopOpacity="0"></stop>
            <stop offset="0.05" stopColor="#2EB9DF"></stop>
            <stop offset="0.5" stopColor="#6FD4F2"></stop>
            <stop offset="1" stopColor="#2EB9DF" stopOpacity="0"></stop>
          ...
          <linearGradient id="pink-pulse-1" x1="0" y1="0" x2="0" y2="100%">
            <stop stopColor="#FF4A81" stopOpacity="0"></stop>
            <stop offset="0.03" stopColor="#FF4A81"></stop>
            <stop offset="0.15" stopColor="#FF87A2"></stop>
            <stop offset="0.5" stopColor="#FFC0E0"></stop>
            <stop offset="0.8" stopColor="#DF6CF6"></stop>
            <stop offset="1" stopColor="#0196FF" stopOpacity="0"></stop>
          </linearGradient>

          <linearGradient id="pink-pulse-2" x1="100" y1="0" x2="0" y2="100%">
            <stop stopColor="#FF4A81" stopOpacity="0"></stop>
            <stop offset="0.056" stopColor="#FF4A81"></stop>
            <stop offset="0.462" stopColor="#DF6CF6"></stop>
            <stop offset="1" stopColor="#0196FF" stopOpacity="0"></stop>
          </linearGradient>

          <linearGradient id="orange-pulse-1" x1="0" y1="0" x2="100%" y2="100%">
            <stop stopColor="#FF7432" stopOpacity="0"></stop>
            <stop offset="0.05" stopColor="#FF7432"></stop>
            <stop offset="0.25" stopColor="#FFA366"></stop>
            <stop offset="0.5" stopColor="white"></stop>
            <stop offset="0.75" stopColor="#F7CC4B"></stop>
            <stop offset="1" stopColor="#F7CC4B" stopOpacity="0"></stop>
          </linearGradient>
          <linearGradient id="orange-pulse-2" x1="0" y1="0" x2="0" y2="100%">
            <stop stopColor="#FF7432" stopOpacity="0"></stop>
            <stop offset="0.05" stopColor="#FF7432"></stop>
            <stop offset="0.25" stopColor="#FFA366"></stop>
            <stop offset="0.5" stopColor="white"></stop>
