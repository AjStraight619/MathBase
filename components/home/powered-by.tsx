...
export default function PoweredBy() {
  ...
  useEffect(() => {
    const handleAnimate = async () => {
      if (scope.current) {
        console.log("starting animation, scope is available");
  ...
  const wolframAnimationPropsRight = {
    animate: {
      pathLength: [0.8, 0],
      pathOffset: [1, 0],
    },
  ...
  const wolframAnimationPropsLeft = {
    animate: {
      pathLength: [1, 0],
      pathOffset: [1, 0],
    },
  ...
  return (
    <div ref={scope} className="mx-auto">
      ...
      >
        <defs>
          <filter id="extremeGlow" x="-50%" y="-50%" width="200%" height="200%">
        ...
        <g clipPath="url(#clip0_601_9)">
          <rect width="6371" height="1712" fill="none" />
          ...
          <defs>
            <linearGradient id="blue-pulse-1" x1="0" y1="100%" x2="100%" y2="0">
              ...
              >
                ...
                <stop offset="0.055" stopColor="#FF7432"></stop>
                <stop offset="0.373" stopColor="#F7CC4B"></stop>
              ...
              >
                <stop stopColor="#FF7432" stopOpacity="0"></stop>
                <stop offset="0.053" stopColor="#FF7432"></stop>
                <stop offset="0.415" stopColor="#F7CC4B"></stop>
                <stop offset="1" stopColor="#F7CC4B" stopOpacity="0"></stop>
              </linearGradient>
            </linearGradient>
          </defs>
          ...
          <g>
            <circle cx="3186" cy="1550" r="18.5" fill="black" />
            <circle cx="3186" cy="1550" r="18.5" stroke="black" />
          </g>
          <g>
            <circle cx="4686" cy="1224" r="18.5" fill="black" />
            <circle cx="4686" cy="1224" r="18.5" stroke="black" />
          </g>
          <g>
            <circle cx="5270" cy="750" r="18.5" fill="black" />
            <circle cx="5270" cy="750" r="18.5" stroke="black" />
          </g>
          <g>
            <circle cx="4221" cy="288" r="18.5" fill="black" />
            <circle cx="4221" cy="288" r="18.5" stroke="black" />
          </g>
          <g>
            <circle cx="3515" cy="215" r="18.5" fill="black" />
            <circle cx="3515" cy="215" r="18.5" stroke="black" />
          </g>
          <g>
            <circle cx="3018" cy="67" r="18.5" fill="black" />
            <circle cx="3018" cy="67" r="18.5" stroke="black" />
          </g>
          <g>
            <circle cx="2159" cy="389" r="18.5" fill="black" />
            <circle cx="2159" cy="389" r="18.5" stroke="black" />
          </g>
